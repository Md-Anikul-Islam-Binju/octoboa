...
@section('admin_content')
    ...
    <div class="sl-pagebody">
        <div class="card pd-20 pd-sm-40">
            <h6 class="card-body-title">Service List
                <a href="#" class="btn btn-primary" style="float: right;" data-toggle="modal" data-target="#modaldemo3">Service Add</a>
            </h6>
                ...
                <table id="datatable1" class="table display responsive nowrap">
                    ...
                    @foreach($services as $key=>$data)
                        <tr>
                            ...
                            <td>
                                <img src="{{'storage/'.$data->logo}}" style="height: 100px; width: 100px;">
                            </td>
                            ...
                            <td>
                                ...
                                <a href="{{route('service.delete',$data->id)}}" class="btn btn-danger btn-sm delete-category" data-toggle="modal" data-target="#deleteModal{{$data->id}}" data-category-id="{{$data->id}}">Delete</a>
                            </td>
                        </tr>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="deleteModalLabel{{$data->id}}">Delete Service</h5>
    ...
    <div id="modaldemo3" class="modal fade">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content tx-size-sm">
                <div class="modal-header pd-x-150">
                    <h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold">Service Add</h6>
                </div>
                @if ($errors->any())
                    <div class="alert alert-danger">
                        <ul>
                ...
                <form action="{{route('service.store')}}" method="post" enctype='multipart/form-data'>
                    ...
                    <div class="modal-body pd-20">
                        ...
                        <div class="form-group">
                            <label for="exampleInputCategory">Logo</label>
                            <input type="file" class="form-control" name="logo" aria-describedby="emailHelp" required>
                        </div>
